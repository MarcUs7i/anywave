    ...
    <>
      ...
      <div className="bg-[#1a1a1f] rounded-lg p-4 flex h-screen flex-col items-center justify-center gap-8">
        <h2 className="text-center font-bold text-3xl leading-tight">
          Welcome to the new Anywave Auth, Choose a way to login or signup!
        </h2>
        <p className="text-center font-bold leading-tight">by using Anywave, you agree to our <a className="text-blue-500 hover:text-blue-600" href="">Privacy Policy + Terms of Service</a></p>
