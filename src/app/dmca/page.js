    ...
    <div>
      ...
      <div className="mx-auto w-[94%] lg:w-[80%]">
        ...
        <p className="mt-4 text-[#bdbdbd]">
          anywave.marcus7i.net is committed to respecting the intellectual property
        ...
        <p className="mt-4 text-[#bdbdbd]">
          None of the files listed on anywave.marcus7i.net are hosted on our servers. All
          links point to content hosted on third-party websites. anywave.marcus7i.net does
          ...
          to{" "}
          <Link href="mailto:info@marcus7i.net" className="text-white">
            info@marcus7i.net
          </Link>{" "}
